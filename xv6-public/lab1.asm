...
int main(int argc, char *argv[])
{
  ...
  6c:	e8 89 07 00 00       	call   7fa <exit2>
	 return 0;
 }
...
int exitWait(void) {
  ...
  ff:	e8 f6 06 00 00       	call   7fa <exit2>
  for (i = 0; i < 2; i++) {
 ...
 13d:	e8 b8 06 00 00       	call   7fa <exit2>
 ...
 161:	e8 8c 06 00 00       	call   7f2 <wait2>
 ...
 1ab:	e8 4a 06 00 00       	call   7fa <exit2>
...
int waitPid(void){
 ...
 426:	e8 cf 03 00 00       	call   7fa <exit2>
...
int CELEBW02(void){
 ...
 503:	e8 f2 02 00 00       	call   7fa <exit2>
